...
const serviceList: ServiceProps[] = [
  ...
  },
  {
    ...
    description:  "کانال تلگرامی مجمع باورمندان کلاب هاوس (جهت اطلاع رسانی از برنامه ها)",
    pro: 0,
  ...
  {
    title: "بات تلگرام",
    description: "پیام رسان ارتباطی(جهت ارسال سوالات، انتقادات، پیشنهادات و نقطه نظرات)",
    pro: 0,
...
export const ServicesSection = () => {
  return (
    <section id="services" className="container py-24 sm:py-32">
      ...
      <h2 className="text-3xl md:text-4xl text-center text-yellow-300 font-bold mb-4">
        تارنماهای مرتبط{" "}
      </h2>
        ...
        {serviceList.map(({ title, description, pro ,link }) => (
          ...
          >
            ...
            <CardHeader>
              ...
              <CardDescription className="text-yellow-300">{description}</CardDescription>
            </CardHeader>
            <Badge
