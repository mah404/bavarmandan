...
export const audioGroups: AudioGroup[] = [
  {
    ...
    files: [
      ...
      {
        title: " جلسه 12  ",
        url: "https://www.dropbox.com/scl/fi/brlv7vamadg01siunr59q/12.mp3?rlkey=l83gig18atzatr29inf99jaf2&st=muhobyx2&dl=1",
      },
      {
        title: " جلسه 13  ",
...
// 🔹 Exported content
export const audioFilesnew: AudioItem[] = [
  {
...
// ===== Data =====
export const miscFiles: AudioFilemisc[] = [
  {
...
export const dropboxAudioMap: DropboxAudioMap = {
...
// ===== Data =====
export const tajridAudios: TajridAudio[] = [
  {
